...
@router.get("/", response_model=List[schemas.CategoriaRead], status_code=status.HTTP_200_OK)
...
@router.get("/{id}", response_model=schemas.CategoriaRead, status_code=status.HTTP_200_OK)
